  ...
  (t.prototype.createPlotGraph = function (t, a, o, e, r, l, i, s) {
    ...
    (t.prototype.init = function () {
      ...
      this.createPieGraph(
        ...
        ["دسکتاپ", "لپتاپ", "تبلت"],
        [20, 30, 15],
        ["#5664d2", "#1cbb8c", "#ebeff2"]
      );
      var a = this.createRealTimeGraph("#flotRealTime", this.randomData(), [
        "#1cbb8c",
      ]);
      a.draw();
      var o = this;
      !(function t() {
        a.setData([o.randomData()]),
          a.draw(),
          setTimeout(t, (n("html").hasClass("mobile-device"), 1e3));
      })();
