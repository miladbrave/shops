...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"اول",sLast:"آخر",sNext:"بعدی",sPrevious:"قبلی"},sEmptyTable:"داده ای یافت نشد",sInfo:"نمایش  _START_ تا  _END_  از _TOTAL_ داده",sInfoEmpty:"نمایش 0 از 0 تا 0 داده",
sInfoFiltered:"(فیلترشده از  _MAX_ کل داده)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"نمایش _MENU_ داده",sLoadingRecords:"درحال بارگذاری...",sProcessing:"درحال پروسس...",sSearch:"جستجو:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"داده ای پیدا نشد"},oSearch:h.extend({},n.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
